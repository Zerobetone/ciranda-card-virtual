...
from .views import dados_cliente,listar_clientes, clonar_cliente, cadastrar_cliente, atualizar_cliente, visualizar_cliente, excluir_cliente
...
urlpatterns = [
   ...
   path('dados_cliente/<int:id>', dados_cliente, name='dados_cliente'),
